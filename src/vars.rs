...
pub fn run() {
  ...
  *y1_ptr = -5;
  ...
  println!("Static memory address s1: {:?}", s1.as_ptr());
  println!("Static memory address s2: {:?}", s2.as_ptr());
  ...
  println!("Stack address of s1 is: {:p}", &s1);
  println!("Stack address of s2 is: {:p}", &s2);
  println!("Heap memory address s1: {:?}", s1.as_ptr());
  println!("Heap memory address s2: {:?}", s2.as_ptr());
  println!("Len of s1: {}", s1.len());
  println!("Len of s2: {}", s2.len());
